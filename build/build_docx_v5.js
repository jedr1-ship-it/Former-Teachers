...
const acknowledgements = [
  ...
  bodyPara('[This policy paper was prepared by the authors for the Former Teachers project. Acknowledgements to colleagues, reviewers and data providers to be added before circulation.]', { run: { italics: true, color: '595959' } }),
];
...
Packer.toBuffer(doc).then(buf => {
  const out = path.join(DIR, 'Former_Teachers_Policy_Paper_v5.docx');
